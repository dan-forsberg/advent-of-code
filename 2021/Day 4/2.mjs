...
do {
  for (const board of boards) {
    ...
    if (board.checkIfWon() && !winningBoards.includes(board)) {
      winningBoards.push(board);
      console.log('Winning boards: ' + winningBoards.length);
    }
  }
...
const wonLast = winningBoards.pop();
const score = wonLast.calculateScore();
